  ...
  return (
    <header className="flex items-center justify-between gap-3 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 sm:px-6 py-4">
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        <button
          onClick={toggleMode}
          className="flex items-center gap-1 text-sm font-medium px-2.5 sm:px-3 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 transition-colors"
        >
          <span>⚡</span>
          <span className="hidden sm:inline">Modo lite</span>
        </button>
        <ThemeToggle />
        <UserMenu />
      </div>
